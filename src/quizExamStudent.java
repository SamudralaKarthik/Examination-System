...
public class quizExamStudent extends javax.swing.JFrame {
    ...
    public void submit(){
        ...
        try{
            ...
            st1.executeUpdate("update student set marks='"+marks+"' where rollNo='"+rollNo+"' ");
            String marks1=String.valueOf(marks);
            setVisible(false);
    ...
    public quizExamStudent(String rollNo) {
        ...
        try{
            ...
            ResultSet rs = st2.executeQuery("select *from student where rollNo ='"+rollNo+"'");
            while(rs.next()){
                jLabel13.setText(rs.getString(2));
            }
            Statement st3=con.createStatement();
            ResultSet rsl = st3.executeQuery("select *from question where id ='"+questionId+"'");
            while(rsl.next()){
                jLabel17.setText(rsl.getString(1));
                jLabel20.setText(rsl.getString(2));
                jRadioButton1.setText(rsl.getString(3));
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(154, 255, 50));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel10.setText("Roll Number:");

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel11.setText("10404");

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel12.setText("Name:");

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel13.setText("Karthik");

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel14.setText("Total Qustions:");
        ...
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(481, 170, -1, -1));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(481, 277, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(481, 344, -1, -1));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(481, 416, -1, -1));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(481, 481, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(481, 576, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1158, 576, -1, 69));

        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pages background student.jpeg"))); // NOI18N
