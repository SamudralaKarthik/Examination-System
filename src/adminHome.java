...
public static int open=0;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -2, 1370, 660));

        jMenuBar1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Navigation Bar", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 36), new java.awt.Color(238, 130, 238))); // NOI18N
        ...
        jMenu6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/all students result.png"))); // NOI18N
        ...
        jMenu7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/log out.png"))); // NOI18N
    ...
    private void jMenu7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu7MouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(jf, "Do you really want logout","Select",JOptionPane.YES_NO_OPTION);
        if(a==0){
            setVisible(false);
    ...
    private void jMenu8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu8MouseClicked
        ...
        JFrame jf = new JFrame();
        jf.setAlwaysOnTop(true);
        int a = JOptionPane.showConfirmDialog(jf, "Do you really want Exit Application","Select",JOptionPane.YES_NO_OPTION);
        if(a==0){
            System.exit(0);
        }
